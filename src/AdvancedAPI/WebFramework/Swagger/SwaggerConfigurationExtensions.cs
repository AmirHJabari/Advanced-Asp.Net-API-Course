...
namespace WebFramework.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            //We call this method for by reflection with the Startup type of entry assmebly (API assembly)
            var mainAssembly = Assembly.GetEntryAssembly(); // => API project assembly
